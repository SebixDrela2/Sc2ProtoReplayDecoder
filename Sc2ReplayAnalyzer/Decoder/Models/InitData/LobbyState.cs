...
{
    public LobbyState(int maxUser, List<Slot> slots, int defaultDifficulty, bool isSinglePlayer, string phase, int? hostUserId, int maxObs, int defaultAIBuild, int pickedMapTag, long randomSeed, int gameDuration)
    {
        MaxUser = maxUser;
        Slots = slots;
