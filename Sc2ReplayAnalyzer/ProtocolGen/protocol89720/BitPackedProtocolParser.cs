...
namespace Sc2ReplayAnalyzer.Json.protocol89720.BitPacked;
...
public class BitPackedProtocolParser(BinaryReader reader) : BitPackedProtocolParserImpl(reader), IBitPackedProtocolParser
{
    ...
    public GameSLobbySlotChange Parse_GameSLobbySlotChange() 
    {
        ...
        switch (variantTag)
        {
            ...
            case 20:
            {
                ...
                return new m_brutalPlusDifficulty
                {
                    Value = res
                };
            }
            case 21:
            {
                var res = Parse_GameCRetryMutationIndexArray();

                return new m_retryMutationIndexes
                {
                    Value = res
                };
            }
            ...
            case 24:
            {
                ...
                return new m_selectedCommanderPrestige
                {
                    Value = res
                };
            }
    ...
    public GameSLobbySlot Parse_GameSLobbySlot() 
    {
        ...
        Option<uint32> m_trophyId = Option.None;
        Option<GameCRewardOverrideArray> m_rewardOverrides = Option.None;
        Option<uint32> m_brutalPlusDifficulty = Option.None;
        Option<GameCRetryMutationIndexArray> m_retryMutationIndexes = Option.None;
        Option<uint32> m_aCEnemyRace = Option.None;
        Option<uint32> m_aCEnemyWaveType = Option.None;
        Option<uint32> m_selectedCommanderPrestige = Option.None;
        if (m_control is { HasValue: false })                           
        {
        ...
        if (m_trophyId is { HasValue: false })                           
        {
            var parsed_m_trophyId = Parse_GameSLobbySlot_m_trophyId();
            m_trophyId = Option.Some(parsed_m_trophyId);
        }
        ...
        if (m_brutalPlusDifficulty is { HasValue: false })                           
        {
            var parsed_m_brutalPlusDifficulty = Parse_GameSLobbySlot_m_brutalPlusDifficulty();
            m_brutalPlusDifficulty = Option.Some(parsed_m_brutalPlusDifficulty);
        }

        if (m_retryMutationIndexes is { HasValue: false })                           
        {
            var parsed_m_retryMutationIndexes = Parse_GameSLobbySlot_m_retryMutationIndexes();
            m_retryMutationIndexes = Option.Some(parsed_m_retryMutationIndexes);
        }

        if (m_aCEnemyRace is { HasValue: false })                           
        {
            var parsed_m_aCEnemyRace = Parse_GameSLobbySlot_m_aCEnemyRace();
            m_aCEnemyRace = Option.Some(parsed_m_aCEnemyRace);
        }

        if (m_aCEnemyWaveType is { HasValue: false })                           
        {
            var parsed_m_aCEnemyWaveType = Parse_GameSLobbySlot_m_aCEnemyWaveType();
            m_aCEnemyWaveType = Option.Some(parsed_m_aCEnemyWaveType);
        }

        if (m_selectedCommanderPrestige is { HasValue: false })                           
        {
            var parsed_m_selectedCommanderPrestige = Parse_GameSLobbySlot_m_selectedCommanderPrestige();
            m_selectedCommanderPrestige = Option.Some(parsed_m_selectedCommanderPrestige);
        }
        ...
        {   
            ...
            m_trophyId = Option.OkOrReturnMissingFieldErr(m_trophyId),
            m_rewardOverrides = Option.OkOrReturnMissingFieldErr(m_rewardOverrides),
            m_brutalPlusDifficulty = Option.OkOrReturnMissingFieldErr(m_brutalPlusDifficulty),
            m_retryMutationIndexes = Option.OkOrReturnMissingFieldErr(m_retryMutationIndexes),
            m_aCEnemyRace = Option.OkOrReturnMissingFieldErr(m_aCEnemyRace),
            m_aCEnemyWaveType = Option.OkOrReturnMissingFieldErr(m_aCEnemyWaveType),
            m_selectedCommanderPrestige = Option.OkOrReturnMissingFieldErr(m_selectedCommanderPrestige),
        };
    }
    ...
    public uint32 Parse_GameSLobbySlot_m_trophyId()
    {                             
        var m_trophyId = Parse_uint32();
        return m_trophyId;
    }
    ...
    public uint32 Parse_GameSLobbySlot_m_brutalPlusDifficulty()
    {                             
        var m_brutalPlusDifficulty = Parse_uint32();
        return m_brutalPlusDifficulty;
    }

    public GameCRetryMutationIndexArray Parse_GameSLobbySlot_m_retryMutationIndexes()
    {                             
        var m_retryMutationIndexes = Parse_GameCRetryMutationIndexArray();
        return m_retryMutationIndexes;
    }

    public uint32 Parse_GameSLobbySlot_m_aCEnemyRace()
    {                             
        var m_aCEnemyRace = Parse_uint32();
        return m_aCEnemyRace;
    }

    public uint32 Parse_GameSLobbySlot_m_aCEnemyWaveType()
    {                             
        var m_aCEnemyWaveType = Parse_uint32();
        return m_aCEnemyWaveType;
    }

    public uint32 Parse_GameSLobbySlot_m_selectedCommanderPrestige()
    {                             
        var m_selectedCommanderPrestige = Parse_uint32();
        return m_selectedCommanderPrestige;
    }
