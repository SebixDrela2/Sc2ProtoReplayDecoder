...
namespace Sc2ReplayAnalyzer.Json.protocol23260;
...
public class ProtocolParser(BinaryReader reader) : ProtocolReader(reader)
{
    ...
    public GameSUserOptionsEvent Parse_GameSUserOptionsEvent() 
    {
        ...
        Option<bool> m_useAIBeacons = Option.None;
        ...
        if (m_useAIBeacons is { HasValue: false })                           
        {
            var parsed_m_useAIBeacons = Parse_GameSUserOptionsEvent_m_useAIBeacons();
            m_useAIBeacons = Option.Some(parsed_m_useAIBeacons);
        }
        ...
        {   
            ...
            m_useAIBeacons = Option.OkOrReturnMissingFieldErr(m_useAIBeacons),
        };
    }
    ...
    public bool Parse_GameSUserOptionsEvent_m_useAIBeacons()
    {                             
        var m_useAIBeacons = parse_bool();
        return m_useAIBeacons;
    }
