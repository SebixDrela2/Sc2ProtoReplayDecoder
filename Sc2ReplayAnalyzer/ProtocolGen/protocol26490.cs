...
namespace Sc2ReplayAnalyzer.Json.protocol26490;
...
public class GameSBankSignatureEvent
{
    ...
    public GameCToonHandle m_toonHandle;
}
...
public class GameSHijackReplayGameUserInfo
{
    ...
    public EObserve m_observe;
    public CUserName m_name;
    public Option<GameCToonHandle> m_toonHandle;
    public Option<CClanTag> m_clanTag;
}
...
// NNet.Game.CToonHandle
public class GameCToonHandle
{
    public List<byte> Value;
}
...
public class ProtocolParser(BinaryReader reader) : ProtocolReader(reader)
{
    ...
    public GameSBankSignatureEvent Parse_GameSBankSignatureEvent() 
    {
        ...
        Option<GameCToonHandle> m_toonHandle = Option.None;
        if (m_signature is { HasValue: false })                           
        {
    ...
    public GameCToonHandle Parse_GameSBankSignatureEvent_m_toonHandle()
    {                             
        var m_toonHandle = Parse_GameCToonHandle();
        return m_toonHandle;
    }
    ...
    public GameSUserOptionsEvent Parse_GameSUserOptionsEvent() 
    {
        ...
        Option<bool> m_startingRally = Option.None;
        ...
        if (m_startingRally is { HasValue: false })                           
        {
            var parsed_m_startingRally = Parse_GameSUserOptionsEvent_m_startingRally();
            m_startingRally = Option.Some(parsed_m_startingRally);
        }
        ...
        {   
            ...
            m_startingRally = Option.OkOrReturnMissingFieldErr(m_startingRally),
    ...
    public bool Parse_GameSUserOptionsEvent_m_startingRally()
    {                             
        var m_startingRally = parse_bool();
        return m_startingRally;
    }
    ...
    {                             
        var m_cmdFlags = parse_packed_int(0, 20);
        return m_cmdFlags;
    }
    ...
    public GameSHijackReplayGameUserInfo Parse_GameSHijackReplayGameUserInfo() 
    {
        ...
        Option<EObserve> m_observe = Option.None;
        Option<CUserName> m_name = Option.None;
        var m_toonHandle = Option.Some<Option<GameCToonHandle>>(Option.None);
        var m_clanTag = Option.Some<Option<CClanTag>>(Option.None);
        if (m_gameUserId is { HasValue: false })                           
        {
    ...
    public Option<GameCToonHandle> Parse_GameSHijackReplayGameUserInfo_m_toonHandle()
    {                             
            var isProvided = parse_bool();

            if (isProvided)
            {
                var res = Parse_GameCToonHandle();
    ...
    public Option<GameCToonHandle> Parse_GameSGameUserJoinEvent_m_toonHandle()
    {                             
            var isProvided = parse_bool();
    ...
    public GameCToonHandle Parse_GameSLobbySlot_m_toonHandle()
    {                             
        var m_toonHandle = Parse_GameCToonHandle();
        return m_toonHandle;
    }
    ...
    public GameCToonHandle Parse_GameCToonHandle()
    {
