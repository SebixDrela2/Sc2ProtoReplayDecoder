namespace MPQArchive.MPQ.ReceivedData
{
    public class MPQArchive
    {
        ...
        public Dictionary<string, ArraySegment<byte>> ListingFiles { get; set; }
      
        public MPQArchive(MPQHeader1 mpqHeader, MPQUserData mpqUserData, Dictionary<string, ArraySegment<byte>> listingFiles)
        {
